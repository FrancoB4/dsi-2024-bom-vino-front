    ...
    return (
        <div className="Container">
            ...
            <button id="btnExportarExcel">
                <a id="btnExportarExcel" href={`http://localhost:8080/api/v1/ranking-de-vinos?fechaInicio=${fechaInicio}&fechaFin=${fechaFin}&resenaPremium=${false}&tipoVisualizacion=${"excel"}`}>
                    EXPORTAR
                </a>
            </button>
